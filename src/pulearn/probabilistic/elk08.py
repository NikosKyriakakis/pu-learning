...
class ENClassifier(PUClassifier):
    ...
    def Ps1y1(self, value):
        if value < 0.0 or value > 1.0:
            raise ValueError(error("Probability values should be between 0-1"))
        self._Ps1y1 = value
    ...
    def predict(self, X, threshold=0.5):
        ...
        try:
            ...
            print(warning("Division by zero in pu_prob method --> Pr(s=1|y=1) = {}".format(self.Ps1y1)))
            predicted_probs = 0
...
class WeightedENCLassifier(ENClassifier):
    ...
    def predict(self, X, threshold=0.5):
        ...
        try:
            ...
            print(warning("Division by zero in predict method"))
            predicted_probs = 0
